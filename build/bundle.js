var app = (function () {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    		...
    		const timer = setInterval(
    			() => {
    				...
    				if (secondsLeft === 0) {
    					...
    					$$invalidate(0, secondsLeft = total);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(2, progress = (total - secondsLeft) / total * 100);
    		}
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash our hands." class="svelte-1wsp3u5"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
